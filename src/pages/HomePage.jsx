  ...
  return (
    <div className="homebg w-full">
      <div className="hero-bg min-h-screen">
        <NavBar />
        {/* Hero + Filter Bar */}
        <div className="flex flex-col py-8 sm:py-20 gap-8 px-4 sm:px-6 lg:px-0 w-full">
          ...
          {/* Filter Inputs */}
          <div className="w-full sm:w-[95%] lg:w-[1238px] mx-auto bg-white/20 p-4 sm:p-6 rounded-lg sm:rounded-2xl">
            <div className="flex flex-col sm:flex-row gap-3 bg-white p-4 rounded-lg shadow">
              ...
              <div className="flex items-center gap-2">
                <button onClick={reduc} className="px-2 py-1 border rounded">
                  −
                </button>
                <span>{bedrooms}</span>
                <button onClick={incre} className="px-2 py-1 border rounded">
                  +
                </button>
              </div>
              <button
                onClick={applyFilters}
                className="bg-[#3D9970] text-white px-4 py-2 rounded hover:bg-[#2f7a5a]"
              >
                Find Property
              </button>
            </div>
